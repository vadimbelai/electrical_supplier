...
from .models import AdvUser, SuperRubric, SubRubric, Es, AdditionalImage
...
AIFormSet = forms.inlineformset_factory(Es, AdditionalImage, fields='__all__')