...
class SuperRubric(Rubric):
    ...
    class Meta:
        ...
        ordering = ('order', 'name')
        verbose_name = 'Надраздел'
        verbose_name_plural = 'Надразделы'
...
class Es(models.Model):
    ...
    author = models.ForeignKey(AdvUser, on_delete=models.CASCADE,
                               verbose_name='Сотрудник, добавивший товар')
...
class AdditionalImage(models.Model):
    es = models.ForeignKey(Es, on_delete=models.CASCADE,
                           verbose_name='Товар')
